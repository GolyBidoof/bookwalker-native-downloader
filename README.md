...
A small [FastAPI](https://fastapi.tiangolo.com/) server (`127.0.0.1:62642`) with a session-based HTTP API. Its [CORS allow-list defaults to the four BookWalker web viewers](https://github.com/GolyBidoof/mokuro-bridge), which is what lets this userscript POST pages from the browser. Per volume it runs:
